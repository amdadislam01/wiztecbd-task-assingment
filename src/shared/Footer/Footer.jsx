...
const Footer = () => {
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 text-white mb-64 gap-10 max-w-[1500px] mx-auto px-6">
        <div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-full text-center pointer-events-none select-none">
        <h1 className="text-[140px] md:text-[220px] font-extrabold tracking-tight text-white opacity-[0.3] leading-none">
          WiztecBD
        </h1>
      </div>
    </footer>
